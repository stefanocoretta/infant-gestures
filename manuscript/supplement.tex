...
## (Intercept)     282.36      28.13  10.037  3.4e-16 ***
## back_oBengali   -63.34      38.75  -1.635    0.106    
## back_oChinese   -35.76      38.67  -0.925    0.358    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Approximate significance of smooth terms:
##                            edf  Ref.df     F p-value    
## s(months)                1.636   1.838 0.887  0.3052    
## s(months):back_oBengali  1.001   1.001 2.148  0.1463    
## s(months):back_oChinese  1.405   1.618 2.887  0.0457 *  
## s(months,dyad)          69.958 109.000 7.067  <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## R-sq.(adj) =  0.836   Deviance explained = 91.2%
## -ML =  972.9  Scale est. = 2858.8    n = 164
\end{verbatim}
...
## -----
##            Model    Score Edf Difference    Df p.value Sig.
## 1 utter_gam_null 977.0534   5                              
## 2      utter_gam 972.8974  11      4.156 6.000   0.216     
## 
## AIC difference: -3.17, model utter_gam_null has lower AIC.
\end{verbatim}
...
## -----
##              Model    Score Edf Difference    Df p.value Sig.
## 1 utter_gam_2_null 979.1766   3                              
## 2      utter_gam_2 977.0534   5      2.123 2.000   0.120     
## 
## AIC difference: 5.05, model utter_gam_2 has lower AIC.
\end{verbatim}
...
## Deviance Residuals: 
##     Min       1Q   Median       3Q      Max  
## -172.80   -49.34   -14.01    44.09   203.25  
## 
## Coefficients:
##                                      Estimate Std. Error t value Pr(>|t|)  
## (Intercept)                         240.86440   93.52664   2.575   0.0117 *
## utt_tot                              -0.15548    0.10833  -1.435   0.1549  
## months18                             78.04806  136.16090   0.573   0.5680  
## backgroundBengali                  -152.35884   99.02146  -1.539   0.1276  
## backgroundChinese                  -186.80332  102.33524  -1.825   0.0715 .
## utt_tot:months18                      0.04140    0.15614   0.265   0.7915  
## utt_tot:backgroundBengali             0.18276    0.11662   1.567   0.1208  
## utt_tot:backgroundChinese             0.21628    0.11928   1.813   0.0733 .
## months18:backgroundBengali            8.57113  143.72135   0.060   0.9526  
## months18:backgroundChinese           44.79628  148.29136   0.302   0.7633  
## utt_tot:months18:backgroundBengali   -0.03118    0.16765  -0.186   0.8529  
## utt_tot:months18:backgroundChinese   -0.04281    0.17135  -0.250   0.8033  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for gaussian family taken to be 6203.931)
## 
##     Null deviance: 863095  on 96  degrees of freedom
## Residual deviance: 527334  on 85  degrees of freedom
...
## Coefficients:
##                                      Estimate Std. Error t value Pr(>|t|)
## (Intercept)                          2.771638  57.855640   0.048    0.962
## utt_tot                              0.004452   0.067015   0.066    0.947
## months18                            26.983493  84.229222   0.320    0.749
## backgroundBengali                    0.893097  61.254741   0.015    0.988
## backgroundChinese                   -0.317611  63.304643  -0.005    0.996
## utt_tot:months18                     0.021159   0.096587   0.219    0.827
## utt_tot:backgroundBengali            0.004350   0.072140   0.060    0.952
## utt_tot:backgroundChinese           -0.002530   0.073784  -0.034    0.973
## months18:backgroundBengali         -36.989072  88.906120  -0.416    0.678
## months18:backgroundChinese          12.209345  91.733131   0.133    0.894
## utt_tot:months18:backgroundBengali   0.053915   0.103708   0.520    0.605
## utt_tot:months18:backgroundChinese  -0.015657   0.105996  -0.148    0.883
## 
## (Dispersion parameter for gaussian family taken to be 2374.038)
## 
##     Null deviance: 267531  on 96  degrees of freedom
## Residual deviance: 201793  on 85  degrees of freedom
##   (23 observations deleted due to missingness)
## AIC: 1042.4
## 
## Number of Fisher Scoring iterations: 2
...
\begin{verbatim}
## Warning: Column `dyad` joining factors with different levels, coercing to
## character vector
\end{verbatim}
