...
The null models for background rop all terms including background (`back_o`) while the null models for development drop the smooth over sampling period (`s(months)`), but keep the random smooths (comparison can be done either on the fixed effect structure or the random effects structure at a time).
