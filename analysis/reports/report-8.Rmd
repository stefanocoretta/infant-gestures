...
The count of all infant gestures is in a significant interaction with months when the outcome variable is understood/said words: the count of infant gestures is positively correlated with understood/said words at 18 months, but not really at 12 months.
A similar pattern can be seen with the H&G and points count, adn the contingent talks count.
The effect of count of maternal utterances on understood and understood/said word count is not significant.
